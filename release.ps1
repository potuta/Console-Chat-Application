...
$appName = "Client" # 👈 Replace with your application project name.
$projDir = "C:\Users\cyy\Desktop\coding\c#\Socket Programming\Console Chat Application\ConsoleChatApp\Client" # 👈 Replace with your project directory (where .csproj resides).
